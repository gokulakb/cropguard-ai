import { a7 as commonjsGlobal, a8 as getDefaultExportFromCjs, r as reactExports, V as clsx, R as React, a9 as invariant } from "./index-DQmXo4u-.js";
...
var _defineProperty$A = defineProperty$2;
var constant$1 = constant_1, defineProperty$1 = _defineProperty$A, identity$8 = identity_1;
...
function LabelList(_ref) {
  ...
  return /* @__PURE__ */ React.createElement(Layer, {
    ...
    return /* @__PURE__ */ React.createElement(Label, _extends$g({}, filterProps(entry, true), others, idProps, {
      ...
      value,
      textBreakAll,
      viewBox: Label.parseViewBox(isNil$1(clockWise) ? entry : _objectSpread$l(_objectSpread$l({}, entry), {}, {
        clockWise
      })),
      key: "label-".concat(index),
      index
...
export {
  ...
  useYAxisWithFiniteDomainOrRandom as t,
  uniqueId as u,
  getCoordinatesOfGrid as v,
  warn as w,
  getTicks as x,
  getTicksOfAxis as y,
  CartesianAxis as z
